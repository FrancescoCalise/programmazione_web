                ...
                if (!info){ 
                    Matematica.findOne({
                        ...
                        if (err) 
                            return res.json({success:false,msg:'non sei autorizzato'});
                        if (mate)
                            return res.json({success:true,msg:'matematica'});
                        if (!mate){
                            Biologia.findOne({
                                account_id:decoded._id
                                ...
                                if (err) 
                                    return res.json({success:false,msg:'non sei autorizzato'});
                                if (bio)
                                    return res.json({success:true,msg:'biologia'});
                                if (!bio){
                                            ...
                                            $set:{
                                                ...
                                                if(doc){
                                                    var materia=appello.esame;
                                                     ...
                                                     //###################################################### ESAMI BIOLOGIA
                                                    if(currentaccount.corso='biologia'){
                                                             //###################################################### CASE 1
                                                            if(materia=='analisi'){
                                                                Biologia.findOne({
                                                                    account_id:currentaccount.account_id,
                                                            ...
                                                            if(materia=='zoologia'){
                                                                Biologia.findOne({
                                                                    account_id:currentaccount.account_id,
                                                                    'zoologia.voto':elenco.voto_provvisorio
                                                            ...
                                                            if(materia=='botanica'){
                                                                Biologia.findOne({
                                                                    account_id:currentaccount.account_id,
                                                                    'botanica.voto':elenco.voto_provvisorio
                                                            ...
                                                            if(materia=='computer_science'){
                                                             ...
                                                             //###################################################### CASE 5
                                                            if(materia=='molecular_biology'){
                                                                Biologia.findOne({
                                                                    account_id:currentaccount.account_id,
                                                                    'molecular_biology.voto':elenco.voto_provvisorio
                                                             ...
                                                             //######################################################  ALTRI CASE PER LA CARRIERA DI BIOLOGIA
                                                        }
                                                             //######################################################  ESAMI MATEMATICA
                                                    if(currentaccount.corso='matematica'){
                                                        if(materia=='analisi'){
                                                             //######################################################  CASE1
                                                            Matematica.findOne({
                                                                account_id:currentaccount.account_id,
                                                             ...
                                                             //###################################################### CASE 2
                                                        if(materia=='ricerca_operativa'){
                                                            Matematica.findOne({
                                                                account_id:currentaccount.account_id,
                                                                'ricerca_operativa.voto':elenco.voto_provvisorio                                                                                            
                                                            }).exec(function(err,info){
                                                                if(err)
                                                                    return res.json({success:false,msg:'errore durante la verifica del voto'});    
                                                                if(info)
                                                        ...
                                                        if(materia=='fisica'){
                                                            Matematica.findOne({
                                                                ...
                                                                //###################################################### ALTRI CASE PER LA CARRIERA MATEMATICA
                                                    }
                                                }
                                            })           
                                        }
