              ...
              if (!req.body.password || !req.body.email || !req.body.username) {
                ...
                newAccount.save(function(err,user){
                    if(err){
                      ...
                      if(req.body.corso=='matematica'){
                          if(req.body.insegnamenti!='fisica' && req.body.insegnamenti!='analisi' && req.body.insegnamenti!='logica' && req.body.insegnamenti!='geometria' && req.body.insegnamenti!='ricerca_operativa')
                            return res.json({success:false,msg:'insegnamento non corretto, per questo corso scegliere tra : fisica,analisi,logica,geometria,ricerca operativa'});
                          else{
                            var newProf = new Prof({
                              account_id:user._id,
                              firstname:req.body.firstname,
                        ...
                        if(req.body.corso=='biologia'){
                          if(req.body.insegnamenti!='molecular_biology' && req.body.insegnamenti!='analisi' && req.body.insegnamenti!='zoologia' && req.body.insegnamenti!='botanica' && req.body.insegnamenti!='computer_science')
                              return res.json({success:false,msg:'insegnamento non corretto, per questo corso scegliere tra : molecular biology,analisi,zoologia,botanica,computer sience'});
                          else{
                            var newProf = new Prof({
                              account_id:user._id,
                              firstname:req.body.firstname,
